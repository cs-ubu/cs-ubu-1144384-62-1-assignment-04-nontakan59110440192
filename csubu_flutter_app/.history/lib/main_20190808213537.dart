...
class _AppHomePageState extends State<AppHomePage> {
  ...
  _getStudents() async {
    var url = 'http://cs.sci.ubu.ac.th:7512/topic-1/Non_59110440192/_search?from=${_page*5}&size=5';
    ...
    if (response.statusCode == 200) {
      ...
      result.forEach((item) {
        if (item.containsKey('_source')) {
          ...
          if (source.containsKey('name') && source.containsKey('price')&& source.containsKey('img')&& source.containsKey('detail')) {
          ...
          return ListTile(
            title: Row(
                  children: <Widget>[
                    ...
                    CircleAvatar(backgroundImage: NetworkImage(student[""])),
